...
aflow_split = load_split_dict("results/aflow_x_mp/ef/train_aflow")
mp_split = load_split_dict("results/aflow_x_mp/ef/train_mp")
...
with open("databases/combine_split.json", 'w', encoding="utf-8") as splits_file:
